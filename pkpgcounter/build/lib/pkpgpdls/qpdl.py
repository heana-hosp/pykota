...
#
# $Id: qpdl.py 3578 2019-02-14 08:46:15Z jerome $
#
...
class Parser(pdlparser.PDLParser):
    ...
    def get_job_size(self):
        ...
        self.tags[0x00] = self.begin_page
        self.tags[0x01] = self.end_page
        self.tags[0x09] = self.maybe_eof
        self.tags[0x0c] = self.begin_band
